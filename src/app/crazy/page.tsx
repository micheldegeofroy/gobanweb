      ...
      <div className="container mx-auto px-4 py-16">
        ...
        <div className="max-w-md mx-auto">
          ...
          <div className="flex justify-center gap-4 mb-8">
            ...
            <div className="w-10 h-10 rounded-full bg-zinc-100 border-2 border-zinc-300 shadow-lg relative overflow-hidden" title="Cross">
        ...
        <div className="max-w-md mx-auto mt-16 text-center">
          ...
          <div className="bg-white/50 dark:bg-zinc-800/50 rounded-xl p-6">
            <ul className="text-sm text-zinc-600 dark:text-zinc-400 space-y-2 text-left">
              <li>• <strong>4 Players</strong> - Black, White, Cross, and Red</li>
